...
class FlowHot(Flow):
    ...
    hot_flows_total_number = 0

    def __init__(self):
        super().__init__()
        self.index = FlowHot.hot_flows_total_number
        FlowHot.hot_flows_total_number += 1
    ...
    def calc_tout_knowing_dq_w_along_flow(self, index_in=None, index_out=None, dq_w_along_flow=None):
        # NOTE: for hot flow dq_w_along_flow > 0    (for cold flow dq < 0)
